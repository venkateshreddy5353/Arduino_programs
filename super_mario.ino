#include <Wire.h>
#include <LiquidCrystal_I2C.h> //download this library by searching "LiquidCrystal_I2C" in your arduino library manager
...
void loop(){
  ...
  if(millis() - buttonLast > 50 && digitalRead(PIN_BUTTON)){
    attachInterrupt(digitalPinToInterrupt(PIN_BUTTON), buttonPush, FALLING);
  } 
  if (buttonPushed) {
